        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <a 
              ...
              className="bg-black text-white px-12 py-5 text-xl font-black hover:bg-white hover:text-black transition-all duration-500 shadow-xl hover:shadow-2xl hover:scale-105 text-center relative overflow-hidden group inline-flex items-center justify-center space-x-3 space-x-reverse"
            >
            ...
            <a 
              ...
              className="bg-white text-red-600 px-12 py-5 text-xl font-black hover:bg-black hover:text-white transition-all duration-500 shadow-xl hover:shadow-2xl hover:scale-105 text-center relative overflow-hidden group inline-flex items-center justify-center space-x-3 space-x-reverse"
            >
